  ...
  return (
    <>
      ...
      <section class="container mx-auto px-4 py-24">
        <div class="grid grid-cols-1 gap-16 text-center md:grid-cols-3">
          <div class="group space-y-4">
            <div class="flex justify-center">
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                class="h-12 w-12 text-(--color-brand-primary) transition-transform duration-300 group-hover:scale-110"
              >
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <h3 class="text-secondary text-xl font-bold tracking-tight">Purely Traceable</h3>
            <p class="leading-relaxed text-(--color-content-muted)">
          ...
          <div class="group space-y-4">
            ...
            <h3 class="text-secondary text-xl font-bold tracking-tight">Rooted Purity</h3>
          ...
          <div class="group space-y-4">
            ...
            <h3 class="text-secondary text-xl font-bold tracking-tight">Seasonal Peak</h3>
            <p class="leading-relaxed text-(--color-content-muted)">
        ...
        <div class="relative z-10 container mx-auto flex flex-col items-center justify-between px-6 md:flex-row">
          <div class="mb-10 text-center md:mb-0 md:text-left">
            ...
            <p class="mt-4 max-w-sm text-sm leading-relaxed text-white/70">
              Seasonal Offer: <span class="text-lg font-bold text-white">20% OFF</span>. <br />
      ...
      <section class="bg-white py-20">
        <div class="container mx-auto px-4">
          <div class="mb-10 flex items-end justify-between">
            <h2 class="text-secondary text-3xl font-bold tracking-tight md:text-4xl">
              Shop the Collection
            </h2>
            <p class="hidden text-(--color-content-muted) italic md:block">
      ...
      <section class="bg-[#F9F7F2] py-20">
        <div class="container mx-auto px-4">
          <div class="mb-12 flex items-end justify-between">
            ...
            <a
              href="#"
              class="group flex items-center gap-2 text-sm font-bold text-[#2C3E2D] transition-colors hover:text-[#8C5E3C]"
            >
              SHOP ALL PRODUCTS
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <section class="bg-white py-20">
        <div class="container mx-auto px-4">
          <div class="mb-10 flex items-end justify-between">
            ...
            <a
              href="#"
              class="group flex items-center gap-2 text-sm font-bold text-[#2C3E2D] uppercase transition-colors hover:text-[#8C5E3C]"
            >
              view all articles
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <section id="coupon-section" class="container mx-auto scroll-mt-20 px-4 py-32">
        <div class="relative flex flex-col items-center justify-around overflow-hidden rounded-4xl border-2 border-[#2C3E2D]/5 bg-[#F3EFDF] p-10 shadow-2xl md:flex-row md:p-16">
          ...
          <div class="relative z-10 mb-10 text-center md:mb-0 md:max-w-md md:text-left">
            ...
            <h2 class="text-4xl font-bold tracking-tight text-[#2C3E2D] md:text-5xl">
              A small taste of <span class="text-[#8C5E3C] italic">home.</span>
            </h2>

            <p class="mt-6 text-sm leading-relaxed text-gray-600 md:text-base">
              We believe the purest flavors are meant to be shared. As a part of our community,
              enjoy <span class="font-bold text-[#2C3E2D]">10% off</span> your first harvest.
            </p>
          ...
          <div class="flex flex-col items-center">
            ...
            <button
              ...
              "
              class="group relative flex items-center gap-3 rounded-full bg-[#2C3E2D] px-12 py-5 font-bold text-white transition-all hover:shadow-2xl active:scale-95"
            >
              <span>COPY CODE</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="mt-4 text-[10px] font-bold tracking-widest text-gray-400 uppercase">
          ...
          <div class="flex flex-col items-stretch overflow-hidden rounded-[2.5rem] border border-[#2C3E2D]/5 bg-[#F3EFDF] shadow-xl md:flex-row">
            ...
            <div class="flex w-full flex-col justify-center p-10 md:w-1/2 md:p-20">
              <div class="max-w-md">
                ...
                <p class="mt-8 flex items-center gap-2 text-[11px] text-gray-400">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
