          ...
          <div className="flex flex-col gap-12 lg:flex-row lg:gap-20">
            <div className="w-full lg:w-3/5">
              ...
              <div className="mt-6 grid grid-cols-4 gap-4">
                <div className="aspect-square cursor-pointer overflow-hidden rounded-xl border-2 border-[#2C3E2D] ring-offset-2 transition-all">
                  <img
                    src="https://storage.googleapis.com/vue-course-api.appspot.com/root/1766909664377.jpg"
                    className="h-full w-full object-cover"
                  />
                </div>
                <div className="aspect-square cursor-pointer overflow-hidden rounded-xl border-transparent opacity-60 transition-all hover:opacity-100">
                  <img
            ...
            <div className="flex w-full flex-col lg:w-2/5">
              ...
              <div className="mt-6 flex items-baseline gap-4">
                <span className="text-3xl font-black tracking-tighter text-[#2C3E2D]">$80</span>
                <span className="text-lg text-gray-400 line-through opacity-60">$120</span>
              </div>
              ...
              <div className="mt-12 space-y-4">
                <div className="flex items-center gap-4">
                  <div className="flex items-center rounded-xl border border-[#2C3E2D]/10 bg-white p-1">
                    <button className="flex h-12 w-12 items-center justify-center rounded-lg text-[#2C3E2D] transition-colors hover:bg-[#F3EFDF]">
                      -
                    </button>
                    <input
                      type="number"
